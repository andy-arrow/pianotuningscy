...
export const faqs: Faq[] = [
  {
    ...
    a: {
      ...
      el: 'Για τα περισσότερα πιάνα που βρίσκονται σε οικιακούς χώρους, συνιστώνται δύο κουρδίσματα τον χρόνο. Οι περισσότεροι κατασκευαστές προτείνουν κούρδισμα κάθε έξι μήνες, ενώ οι κλιματικές συνθήκες της Κύπρου κάνουν την τακτική συντήρηση ακόμη πιο σημαντική. Η εναλλαγή μεταξύ της αυξημένης παραθαλάσσιας υγρασίας και του ξηρότερου αέρα που δημιουργεί η θέρμανση επηρεάζει τα ξύλινα μέρη του πιάνου και μεταβάλλει την τάση των χορδών. Ένα πιάνο που χρησιμοποιείται καθημερινά, για διδασκαλία ή για επαγγελματικές εμφανίσεις, μπορεί να χρειάζεται τρία ή τέσσερα κουρδίσματα τον χρόνο. Εάν έχει παραμείνει ακούρδιστο για μεγάλο χρονικό διάστημα, ενδέχεται να χρειαστεί πρώτα ανύψωση τονικού ύψους και στη συνέχεια ένα λεπτομερές κούρδισμα.',
    },
  },
  {
    id: 'cost',
    ...
    a: {
      ...
      el: 'Το τυπικό κούρδισμα κοστίζει €100 και διαρκεί περίπου μιάμιση ώρα. Περιλαμβάνει πλήρες κούρδισμα στο σωστό τονικό ύψος, καθώς και βασικό έλεγχο του μηχανισμού και της ποιότητας του ήχου. Εάν το πιάνο βρίσκεται πολύ χαμηλότερα από το σωστό τονικό ύψος, ενδέχεται να χρειαστεί πρώτα ανύψωση τόνου. Η ανάγκη και το κόστος αυτής της διαδικασίας εξηγούνται και συμφωνούνται πριν από την έναρξη οποιασδήποτε εργασίας, ώστε να μην υπάρξουν απρόβλεπτες χρεώσεις.',
    },
  },
  {
    id: 'areas',
  ...
  },
  {
    ...
    q: {
      ...
      el: 'Χρειάζεται κούρδισμα το πιάνο μετά τη μεταφορά;',
    },
    a: {
      ...
      el: 'Ναι, αλλά συνήθως όχι αμέσως. Η μεταφορά από μόνη της σπάνια προκαλεί σημαντικό ξεκούρδισμα. Ο βασικότερος παράγοντας είναι η αλλαγή του περιβάλλοντος, καθώς η θερμοκρασία και η υγρασία του νέου χώρου επηρεάζουν σταδιακά το ξύλο και την τάση των χορδών. Συνιστάται να αφήσετε το πιάνο να προσαρμοστεί στον νέο χώρο για περίπου δύο έως τέσσερις εβδομάδες και στη συνέχεια να προγραμματίσετε το κούρδισμά του. Εάν κουρδιστεί αμέσως μετά τη μεταφορά, υπάρχει πιθανότητα να χρειαστεί νέο κούρδισμα μόλις ολοκληρωθεί η προσαρμογή του.',
    },
  },
  {
    id: 'air-conditioning',
  ...
  },
  {
    ...
    a: {
      ...
      el: 'Ένα τυπικό κούρδισμα διαρκεί περίπου μιάμιση ώρα. Εάν το πιάνο χρειάζεται ανύψωση τονικού ύψους, η διαδικασία μπορεί να διαρκέσει περισσότερο. Αρχικά πραγματοποιείται ένα προκαταρκτικό κούρδισμα, ώστε να επανέλθει σταδιακά η συνολική τάση των χορδών. Στη συνέχεια ακολουθεί το λεπτομερές κούρδισμα, αφού το όργανο προσαρμοστεί στη νέα τάση. Κατά τη διάρκεια του ραντεβού, είναι σημαντικό ο χώρος να παραμένει όσο το δυνατόν πιο ήσυχος, καθώς το κούρδισμα απαιτεί προσεκτική ακρόαση και μεγάλη συγκέντρωση.',
    },
  },
  {
    id: 'new-piano',
    ...
    a: {
      ...
      el: 'Ναι. Ένα καινούριο πιάνο χρειάζεται συνήθως συχνότερο κούρδισμα κατά τα πρώτα δύο χρόνια της ζωής του. Οι νέες χορδές τεντώνονται σταδιακά, ενώ τα ξύλινα μέρη και τα υλικά του οργάνου προσαρμόζονται στην τάση και στις συνθήκες του χώρου. Τρία έως τέσσερα κουρδίσματα κατά τον πρώτο χρόνο θεωρούνται απολύτως φυσιολογικά και βοηθούν το πιάνο να σταθεροποιηθεί σωστά. Η ανάγκη για συχνότερο κούρδισμα δεν σημαίνει ότι υπάρχει κάποιο πρόβλημα με το όργανο.',
    },
  },
  {
    id: 'outdoor-event',
