...
export const services: Service[] = [
  {
    ...
    el: {
      ...
      tagline: 'Κούρδισμα επιπέδου συναυλίας, σε όλη την Κύπρο',
      metaDescription:
      ...
      includes: [
        ...
        'Αναφορά για την κατάσταση του οργάνου σε απλά λόγια',
        'Συμβουλές για τη σωστή θέση του πιάνου στον χώρο σας',
      ],
      priceNote:
        'Πιάνα που έμειναν πολλά χρόνια ακούρδιστα μπορεί να χρειαστούν πρώτα ανύψωση τόνου — ένα πρόχειρο κούρδισμα για να επανέλθει η τάση, και στη συνέχεια λεπτό κούρδισμα. Αυτό κοστολογείται πριν ξεκινήσει οποιαδήποτε εργασία.',
    },
  },

  {
    ...
    el: {
      name: 'Επισκευές & Ρύθμιση Μηχανισμού',
      tagline: 'Να κάνει ο μηχανισμός αυτό που ζητούν τα δάχτυλά σας',
      metaDescription:
      ...
      body: [
        'Ο μηχανισμός ενός πιάνου με ουρά έχει πάνω από 8.000 κινούμενα μέρη, και ένα όρθιο πιάνο δεν πάει πίσω. Οι τσόχες συμπιέζονται, τα υφάσματα φθείρονται, οι κόλλες στεγνώνουν και οι βίδες χαλαρώνουν. Το αποτέλεσμα είναι ένα πιάνο που αντιστέκεται στον πιανίστα: πλήκτρα που κολλούν, νότες που δεν επαναλαμβάνονται, αφή βαριά στη μία οκτάβα και ελαφριά στην επόμενη.',
        'Η ρύθμιση είναι η διαδικασία επαναφοράς όλων αυτών των μερών στις σωστές γεωμετρικές τους σχέσεις. Είναι υπομονετική δουλειά χωρίς λάμψη, και αλλάζει το αίσθημα του οργάνου πολύ περισσότερο απ’ όσο περιμένουν οι περισσότεροι ιδιοκτήτες. Πολλά πιάνα που θεωρούνται «κουρασμένα» απλώς χρειάζονται ρύθμιση.',
        'Οι επισκευές κοστολογούνται μετά από έλεγχο, γιατί το να μαντεύει κανείς τιμή χωρίς να ανοίξει το πιάνο δεν εξυπηρετεί κανέναν. Θα μάθετε τι φταίει, τι θα κοστίσει και — με την ίδια ειλικρίνεια — πότε μια επισκευή δεν αξίζει να γίνει.',
      ],
      includes: [
        'Πλήκτρα που κολλούν ή δεν επαναλαμβάνουν',
        'Διαμόρφωση, ανακαίνιση και αντικατάσταση σφυριών',
        'Ρύθμιση πνιγέων και εξάλειψη βόμβου',
        'Ευθυγράμμιση πλήκτρων και ρύθμιση βάθους',
        'Επισκευές πεταλιών και μηχανισμού μετάδοσης',
        'Αντικατάσταση και συγκόλληση σπασμένων χορδών',
        'Διαμόρφωση ήχου για ομοιομορφία στις νότες',
      ],
      priceNote: 'Κοστολόγηση μετά από έλεγχο. Μικροεπισκευές γίνονται συχνά κατά τη διάρκεια της επίσκεψης κουρδίσματος χωρίς επιπλέον χρέωση μετάβασης.',
    },
  },
