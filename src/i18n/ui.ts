...
export const ui = {
  en: {
    ...
    'chat.launcher': 'Ask us anything',
    'chat.open': 'Open the chat assistant',
    'chat.title': 'Piano Tunings Cy',
    'chat.subtitle': 'AI assistant · instant answers',
    'chat.close': 'Close chat',
    'chat.restart': 'Start a new conversation',
    'chat.welcome':
      'Hello! I’m the Piano Tunings Cy assistant — an AI, not Kleanthis himself. Ask me about tuning, repairs, moving, prices or the areas we cover. When you’re ready to book, I’ll put you straight through to him.',
    'chat.suggestions':
      'How much is a tuning?|Do you cover Paphos?|Can you move a grand piano?|How often should I tune?',
    'chat.inputLabel': 'Your question',
    'chat.placeholder': 'Type your question…',
    'chat.send': 'Send',
    'chat.thinking': 'Writing a reply…',
    'chat.you': 'You',
    'chat.assistant': 'Assistant',
    'chat.disclaimer': 'AI answers can be wrong — confirm prices and times with Kleanthis.',
    'chat.privacy': 'Privacy',
    'chat.error': 'Sorry — I can’t answer right now. You can reach Kleanthis directly:',
    'chat.rate': 'You’re sending messages quickly — please wait a few seconds and try again.',
    'chat.quota': 'The assistant is taking a break for now. Kleanthis is happy to answer you directly:',
    'chat.limit': 'We’ve covered a lot! For anything more, Kleanthis is the best person to ask:',
    'chat.daily': 'You’ve reached today’s limit for the assistant; it resets at midnight, Cyprus time. Kleanthis is happy to answer you directly:',
    'chat.tooLong': 'Please keep your message under 600 characters.',
    'chat.actionCall': 'Call Kleanthis',
    'chat.actionWhatsapp': 'WhatsApp',
    'chat.actionBook': 'Book online',
  ...
  el: {
    ...
    // Header only: the full label doesn't fit the Greek nav on one line.
    'nav.faqShort': 'Ερωτήσεις',
    ...
    'label.varies': 'Η διάρκεια εξαρτάται από το είδος και την έκταση της εργασίας.',
    ...
    'home.heroLead':
      'Κούρδισμα συναυλιακού επιπέδου, επισκευές, πλήρεις ανακατασκευές, ασφαλείς μεταφορές και ενοικιάσεις πιάνων σε ολόκληρη την Κύπρο. Από το οικογενειακό όρθιο πιάνο μέχρι το συναυλιακό πιάνο με ουρά σε μια επαγγελματική σκηνή.',
    'home.trustYears': 'χρόνια στην Κύπρο',
    'home.trustIsland': 'σε όλο το νησί',
    'home.servicesEyebrow': 'Τι κάνουμε',
    'home.servicesTitle': 'Όλα όσα χρειάζεται το πιάνο σας, από έναν εξειδικευμένο τεχνικό',
    'home.servicesLead':
      'Κούρδισμα, επισκευή, ανακατασκευή, μεταφορά και ενοικίαση πιάνων. Με προσωπική εξυπηρέτηση από τον ίδιο άνθρωπο που θα απαντήσει στο τηλέφωνό σας.',
    'home.aboutEyebrow': 'Ποιος θα φροντίσει το πιάνο σας',
    ...
    'contact.lead':
      'Τηλεφωνήστε, στείλτε μήνυμα στο WhatsApp ή συμπληρώστε τη φόρμα επικοινωνίας. Απαντώ προσωπικά σε κάθε μήνυμα, συνήθως μέσα στην ίδια ημέρα.',
    'contact.formTitle': 'Στείλτε μήνυμα',
    'contact.fastestTitle': 'Ο γρηγορότερος τρόπος επικοινωνίας',
    'contact.fastestLead':
      'Για άμεση εξυπηρέτηση, καλέστε με ή στείλτε μου μήνυμα στο WhatsApp. Αυτός είναι ο γρηγορότερος τρόπος επικοινωνίας, ιδιαίτερα για επείγουσες εργασίες ή κρατήσεις πιάνου για εκδηλώσεις.',
    ...
    'footer.tagline':
      'Κούρδισμα, επισκευή, ανακατασκευή και ασφαλής μεταφορά πιάνων σε ολόκληρη την Κύπρο από το 2011.',
    ...
    'chat.launcher': 'Ρωτήστε μας',
    'chat.open': 'Άνοιγμα του βοηθού συνομιλίας',
    'chat.title': 'Piano Tunings Cy',
    'chat.subtitle': 'Βοηθός AI · άμεσες απαντήσεις',
    'chat.close': 'Κλείσιμο συνομιλίας',
    'chat.restart': 'Νέα συνομιλία',
    'chat.welcome':
      'Γεια σας! Είμαι ο ψηφιακός βοηθός του Piano Tunings Cy — τεχνητή νοημοσύνη, όχι ο ίδιος ο Κλεάνθης. Ρωτήστε με για κούρδισμα, επισκευές, μεταφορά, τιμές ή τις περιοχές που καλύπτουμε. Όταν είστε έτοιμοι για ραντεβού, θα σας φέρω απευθείας σε επαφή μαζί του.',
    'chat.suggestions':
      'Πόσο κοστίζει το κούρδισμα;|Καλύπτετε την Πάφο;|Μεταφέρετε πιάνα με ουρά;|Κάθε πότε πρέπει να κουρδίζω;',
    'chat.inputLabel': 'Η ερώτησή σας',
    'chat.placeholder': 'Γράψτε την ερώτησή σας…',
    'chat.send': 'Αποστολή',
    'chat.thinking': 'Γράφω απάντηση…',
    'chat.you': 'Εσείς',
    'chat.assistant': 'Βοηθός',
    'chat.disclaimer': 'Οι απαντήσεις AI μπορεί να έχουν λάθη — επιβεβαιώστε τιμές και ώρες με τον Κλεάνθη.',
    'chat.privacy': 'Απόρρητο',
    'chat.error': 'Συγγνώμη — δεν μπορώ να απαντήσω αυτή τη στιγμή. Μπορείτε να επικοινωνήσετε απευθείας με τον Κλεάνθη:',
    'chat.rate': 'Στέλνετε μηνύματα πολύ γρήγορα — περιμένετε λίγα δευτερόλεπτα και δοκιμάστε ξανά.',
    'chat.quota': 'Ο βοηθός κάνει ένα διάλειμμα προς το παρόν. Ο Κλεάνθης θα σας απαντήσει ευχαρίστως απευθείας:',
    'chat.limit': 'Καλύψαμε αρκετά! Για οτιδήποτε άλλο, καλύτερα να ρωτήσετε απευθείας τον Κλεάνθη:',
    'chat.daily': 'Φτάσατε το σημερινό όριο του βοηθού· ανανεώνεται τα μεσάνυχτα, ώρα Κύπρου. Ο Κλεάνθης θα σας απαντήσει ευχαρίστως απευθείας:',
    'chat.tooLong': 'Το μήνυμα πρέπει να είναι έως 600 χαρακτήρες.',
    'chat.actionCall': 'Καλέστε τον Κλεάνθη',
    'chat.actionWhatsapp': 'WhatsApp',
    'chat.actionBook': 'Κλείστε ραντεβού',
