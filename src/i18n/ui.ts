...
export const ui = {
  en: {
    ...
    'chat.quota': 'The assistant is resting until {time} (Cyprus time). Kleanthis is happy to answer you directly:',
    'chat.limit': 'We’ve covered a lot! For anything more, Kleanthis is the best person to ask:',
    'chat.daily': 'You’ve reached today’s limit for the assistant; it resets at {time} (Cyprus time). Kleanthis is happy to answer you directly:',
  ...
  el: {
    ...
    'chat.quota': 'Ο βοηθός ξεκουράζεται μέχρι τις {time} (ώρα Κύπρου). Ο Κλεάνθης θα σας απαντήσει ευχαρίστως απευθείας:',
    'chat.limit': 'Καλύψαμε αρκετά! Για οτιδήποτε άλλο, καλύτερα να ρωτήσετε απευθείας τον Κλεάνθη:',
    'chat.daily': 'Φτάσατε το σημερινό όριο του βοηθού· ανανεώνεται στις {time} (ώρα Κύπρου). Ο Κλεάνθης θα σας απαντήσει ευχαρίστως απευθείας:',
